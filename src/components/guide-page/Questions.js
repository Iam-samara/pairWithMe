		...
		return (
			<div>
			  ...
			  <label>Why Pair Program?</label>
					<p className='bordered'>
						Pair Programming allows you to have two minds working on the same problem making it much easier and faster to solve. It also forces you to express your logic in an effecticient manor. Pair programming forces you to write better code faster.
		
					</p>
				<label>How to Pair Program?</label>
					<p className='bordered'>
						To pair proram take shifts revolving every 15 to 30 minutes or every other challenge. As one partner takes on the role of driver and actually types out the code. The other partner assumes the role of navigator and they are in charge of research and helping the driver through blocks. As the driver types the navigator should watch for errors and problems with the logic. At all times both partners should be able to articulate there logic and thoughts.
					</p>
				<label>Who Can Pair Program?</label>
					<p className='bordered'>
						We recommend that anyone wanting to start with going through tutorials like Codeschool or Codeacademy to have a basic understanding of what programming is. After that there are plenty of people on our site that love teaching through pair programming. So the simple awnser to that anyone can program!
					</p>
				<label>When to Pair Program</label>
					<p className='bordered'>
						Anytime you are willing to share and use different views on a project. There are few instances in which pair programming will not be the most effecient, and funnest, way to program. 
					</p>
